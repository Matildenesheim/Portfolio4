...
```{r}
library(pacman)
p_load(tidyverse, crqa, readr, groupdata2, gridExtra, stringr, lme4, lmerTest)

setwd("~/Desktop/OneDrive/Cognitive Science/3 semester/Experimental Methods 3/Portfolio_4")
...
surPair_rqa = dplyr::select(surPair_rqa, -c(group1, group2))
...
summary(mDET) #significant
summary(mNRLINE) 
summary(mTT) #significant
summary(mL) #significant
summary(mMaxL) #significant
summary(mENTR) #significant
summary(mrENTR) # significant
summary(mLAM) #significant
